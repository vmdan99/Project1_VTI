...
public class ResponseUser_ActiveTemp {
    ...
    public ResponseUser_ActiveTemp(String code, String message, Integer responseTime, String secret, String token, User user) {
        this.code = code;
        this.message = message;
        this.responseTime = responseTime;
        this.secret = secret;
